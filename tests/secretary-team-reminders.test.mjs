...
function fixture(t) {
  ...
  db.exec(`PRAGMA foreign_keys=ON;
    ...
    INSERT INTO tasks VALUES('t1','مهمة خالد الأولى','تفاصيل','red','progress','خالد','خالد',1,NULL,NULL,NULL,1,1,NULL,NULL);
    INSERT INTO tasks VALUES('t2','مهمة شادي','تفاصيل','yellow','open',NULL,'شادي',1,NULL,NULL,NULL,1,1,NULL,NULL);
    INSERT INTO tasks VALUES('t3','مهمة مكتملة','تفاصيل','green','completed','خالد','خالد',1,NULL,1,NULL,1,1,NULL,NULL);`);
  migrateSecretary(db);
