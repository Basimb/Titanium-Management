...
function fixture(t) {
  ...
  db.exec(`PRAGMA foreign_keys=ON;
    ...
    INSERT INTO tasks VALUES('t-khaled','مهمة خالد','تفاصيل','red','progress','خالد','خالد',1,NULL,NULL,NULL,1,1,NULL,NULL);
    INSERT INTO tasks VALUES('t-khaled-2','مهمة خالد الثانية','تفاصيل','green','open',NULL,'خالد',1,NULL,NULL,NULL,1,1,NULL,NULL);
    INSERT INTO tasks VALUES('t-other','مهمة شادي','تفاصيل','yellow','open',NULL,'شادي',1,NULL,NULL,NULL,1,1,NULL,NULL);`);
  migrateSecretary(db);
