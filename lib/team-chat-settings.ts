...
export const ALLOWED_KEYS = ["TEAM_CHAT_ENABLED", "TEAM_CHAT_SHARED_KEY", "TEAM_CHAT_CONTACTS_JSON", "TEAM_CHAT_GROUP_IDS_JSON", "GROQ_API_KEY", "GROQ_MODEL", "OPENAI_API_KEY", "OPENAI_MODEL", "OPENAI_SEARCH_MODEL",
  ...
  "ODOO_REPORT_ENABLED", "ODOO_URL", "ODOO_DB", "ODOO_USERNAME", "ODOO_API_KEY", "ODOO_LOW_STOCK_THRESHOLD", "ODOO_CURRENCY_LABEL", "ODOO_REPORT_DAILY_HOUR", "ODOO_REPORT_WEEKLY_DAY", "ODOO_REPORT_WEEKLY_HOUR", "ODOO_REPORT_PURCHASES_WEEKLY_HOUR",
